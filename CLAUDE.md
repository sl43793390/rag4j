...
**rag4j** is a Java 21 Spring Boot 4.0.6 RAG (Retrieval-Augmented Generation) application built with Maven and the LangChain4j ecosystem. It is designed as an AI-powered document processing and retrieval system.
...
- **LLM**: `qwen3.5-flash` via `dmxapi.cn` proxy, `text-embedding-3-small` for embeddings
...
This is a newly scaffolded project with dependencies pre-configured but no custom business logic implemented yet. The entry point and test are bare Spring Boot stubs.
